...
export function buildMailList(endpoint) {
  return {
    ...
    renderHtmlIframe() {
      ...
      const style = dark
        ? `body{font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:rgb(230,230,230) !important;background-color:rgb(39,39,39) !important;line-height:1.6;padding:12px;margin:0}body *{color:inherit}div,p,span,li,dd,dt{color:rgb(230,230,230) !important}img{max-width:100%}a{color:#60a5fa !important}blockquote{border-left:3px solid rgb(57,57,57) !important;margin:8px 0;padding:4px 12px;color:rgb(160,160,160) !important;background:rgb(24,24,24) !important}table{border-color:rgb(57,57,57) !important;background-color:rgb(39,39,39) !important}td,th{border-color:rgb(57,57,57) !important;color:rgb(230,230,230) !important;background-color:rgb(39,39,39) !important}font{color:rgb(230,230,230) !important}`
